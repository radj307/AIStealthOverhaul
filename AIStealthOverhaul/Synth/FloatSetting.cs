namespace AIStealthOverhaul.Synth
{
    ...
    {
        #region Constructors
        public FloatSetting(bool enable, float value) : base(enable, value) { }
        public FloatSetting(bool enable, double value) : base(enable, Convert.ToSingle(value)) { }
        public FloatSetting(bool enable, decimal value) : base(enable, Convert.ToSingle(value)) { }
