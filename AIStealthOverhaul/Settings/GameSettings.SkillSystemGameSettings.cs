...
namespace StealthOverhaul.Settings
{
    public partial class GameSettings
    {
        public class SkillSystemGameSettings : IGameSettingsCategory
        {
            ...
            public Setting<float> fSneakSkillMult = new();
            ...
            public Setting<float> fPlayerDetectionSneakMult = new();
            ...
            public Setting<float> fPlayerDetectionSneakBase = new();
            ...
            public Setting<float> fSneakPerceptionSkillMax = new();
            ...
            public Setting<float> fSneakPerceptionSkillMin = new();
